...
namespace Mgm.VI.Notification.UnitTests
{
    public class UnitTest_AwsSesSmtp : UnitTest_NotificationBase
    {
        #region Instantiate Class
        [Fact]
        public void Success_Test_Instantiate_Valid_AwsSesSmtp()
        {
            AwsSesSmtp smtp = new AwsSesSmtp();
            Assert.True(smtp != null, " AwsSesSmtp: Instantiate(...) From Content Successful Test Passed.");
        }
        [Fact]
